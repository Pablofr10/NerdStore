...
public class ProdutoAppService : IProdutoAppService
{
    ...
    {
        var podeDebitarEstoque = await _estoqueService.DebitarEstoque(id, quantidade);

        if (!podeDebitarEstoque) throw new DomainException("Falha ao debitar estoque");
    ...
    {
        var podeReporEstoque = await _estoqueService.ReporEstoque(id, quantidade);

        if (!podeReporEstoque) throw new DomainException("Falha ao repor estoque");
